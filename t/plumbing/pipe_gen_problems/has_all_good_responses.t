...
;GB[1]W[ri])
(
;GM[1]FF[4]AB[nc][pd][qc][qk]AW[qf][qi][rd]CA[UTF-8]CR[rh]GC[refute_bad_move task]PL[B]SZ[19]
;B[rh]
;W[qh]
;B[ri]GB[1]LB[qh:?])
(
;GM[1]FF[4]AB[nc][pd][qc][qk][rh]AW[qf][qi][rd]C[Which marked moves are good and bad for White?]CA[UTF-8]CR[jj]GC[question rate_choices task]LB[rh:1]MN[-1]PL[W]SQ[qh][ri]SZ[19]
;CR[ri]MA[qh]W[jj]
